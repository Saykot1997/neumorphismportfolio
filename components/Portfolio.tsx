            ...
            <div className=' max-w-[900px] mx-auto'>
                ...
                <div className=' w-full flex justify-center'>
                    <div className='bg-gray-100 p-2 rounded customShadow flex items-center mt-10'>
                        <span className=' inline-block font-semibold px-4 border-r border-primary cursor-pointer customInsetShadow2'>HTML</span>
                        <span className=' inline-block font-semibold px-4 border-r border-primary cursor-pointer'>CSS</span>
                        <span className=' inline-block font-semibold px-4 border-r border-primary cursor-pointer'>React js</span>
                        <span className=' inline-block font-semibold px-4 border-r border-primary cursor-pointer'>Next js</span>
                        <span className=' inline-block font-semibold px-4 cursor-pointer'>Node js</span>
                    </div>
                </div>
                <div className=' mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 '>
                    <div className='customShadow hover:scale-105 transition-all duration-200 ease-linear cursor-pointer w-full px-3 py-4 rounded-md bg-gray-100'>
