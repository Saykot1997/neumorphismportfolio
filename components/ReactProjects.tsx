...
export default function ReactProjects({ showShort }: PropsType) {
    return (
        <div className=' mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 '>
            <a href="https://glassmorphism-protfolio.vercel.app/works/ticketing" target={"_blank"} rel="noreferrer">
            ...
            <a href="https://glassmorphism-protfolio.vercel.app/works/space" target={"_blank"} rel="noreferrer">
                <div className='customShadow hover:scale-105 transition-all duration-200 ease-linear cursor-pointer w-full px-2 pb-5 pt-2  rounded-md bg-gray-100'>
                    <div className=' w-full h-[200px]'>
            ...
            <a href="https://glassmorphism-protfolio.vercel.app/works/reactRwebsite" target={"_blank"} rel="noreferrer">
                <div className='customShadow hover:scale-105 transition-all duration-200 ease-linear cursor-pointer w-full px-2 pb-5 pt-2  rounded-md bg-gray-100'>
                    <div className=' w-full h-[200px]'>
