            ...
            <div className=' max-w-[1000px] mx-auto'>
                    ...
                    <div className=' w-full'>
                        ...
                        <div>
                            <div className=' grid grid-cols-12 gap-2 my-5 items-center'>
                                <p className=' col-span-2 text-blue-500 font-semibold text-right'>Name</p>
                            ...
                            <div className=' grid grid-cols-12 gap-2 my-5 items-center'>
                                <p className=' col-span-2 text-blue-500 font-semibold text-right'>Email</p>
                                <div className=' col-span-10'>
                            ...
                            <div className=' grid grid-cols-12 gap-2 my-5 items-center'>
                                <p className=' col-span-2 text-blue-500 font-semibold text-right'>Phone</p>
                                <div className=' col-span-10'>
                            ...
                            <div className=' grid grid-cols-12 gap-2 mt-5'>
                                <p className=' col-span-2 text-blue-500 font-semibold text-right'>Message</p>
                                <div className=' col-span-10'>
                ...
                <div className=' w-full grid grid-cols-2 gap-3 mt-10'>
                    <div className=' grid grid-cols-12 gap-3'>
                        <p className=' col-span-2 text-blue-500 font-semibold text-right'></p>
                        <div className=' col-span-10'>
                            <button className=' text-primary font-semibold bg-[#edeef3] w-full py-3 rounded customShadow hover:scale-105 transition-all duration-200 ease-linear'>Send Message</button>
